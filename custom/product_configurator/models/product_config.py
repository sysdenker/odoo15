...
class ProductConfigDomainLine(models.Model):
    ...
    domain_id = fields.Many2one(
        comodel_name="product.config.domain", required=True, ondelete='cascade', string="Rule"
    )
    condition = fields.Selection(
        selection=_get_domain_conditions, string="Condition", required=True,  ondelete='cascade'
    )
...
class ProductConfigSession(models.Model):
    ...
    user_id = fields.Many2one(
        comodel_name="res.users", required=True,ondelete='cascade', string="User"
    )
