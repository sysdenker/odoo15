class amount_to_text:
    ...
    def amount_to_text_cheque(self, nNumero, intermedio="pesos ", sufijo="M. N."):
        ...
        intCantDecimal = int(self.extraeDecimales(nNumero))
        if intCantDecimal <= 9:
                ...
                if prim != 0:
                    ...
                    if prim != 0:
                        ...
                        if lFemenino and n == 1:
                            ...
                            cRes = self._n1[int(n - 1)]
                        else:
                            prim, resto = divmod(n, 10)
                            cRes = self._n2[int(prim) - 1]
                            if resto != 0:
                                if prim == 2:
                                    cRes += self._n11[int(resto) - 1]
                                else:
                                    cRes += " y " + self._n1[int(resto) - 1]
